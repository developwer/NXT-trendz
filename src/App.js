    ...
    return (
      <CartContext.Provider
        value={{
          ...
          incrementCartItemQuality: this.incrementCartItemQuality,
          decrementCartItemQuality: this.decrementCartItemQuality,
